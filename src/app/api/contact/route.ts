        ...
        <div style="padding: 20px;">
            ...
            <div style="background: #f8fafc; border-radius: 8px; padding: 20px; border: 1px solid #e2e8f0; display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #3b82f6; margin-bottom: 12px;">
                    ...
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${
                      first_name || ""
                    } ${last_name || ""}</p>
                </div>
                `
                ...
                <!-- Age - Only shown if age exists -->
${
  age
    ? `
<div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #3b82f6; margin-bottom: 12px;">
    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">Age:</strong>
    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${age}</p>
</div>
`
    : ""
}
                ...
                <!-- State - Only shown if state exists -->
                ${
                  state
                    ? `
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #8b5cf6; margin-bottom: 12px;">
                    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">State:</strong>
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${state}</p>
                </div>
                `
                    : ""
                }
                 <!-- Date - Only shown if date exists -->
        ${
          date
            ? `
        <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #3b82f6; margin-bottom: 12px;">
            <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">Preferred Date:</strong>
            <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${date}</p>
        </div>
        `
            : ""
        }
                <!-- City - Only shown if city exists -->
                ${
                  city
                    ? `
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #8b5cf6; margin-bottom: 12px;">
                    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">City:</strong>
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${city}</p>
                </div>
                `
                    : ""
                }
                
                <!-- Options - Only shown if options exists -->
                ${
                  options
                    ? `
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #f59e0b; margin-bottom: 12px;">
                    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">Options:</strong>
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${options}</p>
                </div>
                `
                    : ""
                }
                
                <!-- Courses - Only shown if course exists -->
                ${
                  course
                    ? `
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #f59e0b; margin-bottom: 12px;">
                    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">Courses:</strong>
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${course}</p>
                </div>
                `
                    : ""
                }
                
                <!-- Availability - Only shown if availability exists -->
                ${
                  availability
                    ? `
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #f59e0b; margin-bottom: 12px;">
                    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">Availability:</strong>
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${availability}</p>
                </div>
                `
                    : ""
                }
                
                <!-- 12th with Physics and Maths - Only shown if is_12th_completed exists -->
                ${
                  is_12th_completed
                    ? `
                <div style="background: white; padding: 12px; border-radius: 6px; border-left: 3px solid #ef4444; margin-bottom: 12px;">
                    <strong style="color: #1f2937; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">12th with Physics and Maths:</strong>
                    <p style="color: #374151; margin: 4px 0 0; font-size: 15px; font-weight: 500;">${is_12th_completed}</p>
                </div>
                `
                    : ""
                }
