        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              <span data-label="J" className="--i: 1">
                J
              </span>
              <span data-label="o" className="--i: 2">
                o
              </span>
              <span data-label="i" className="--i: 3">
                i
              </span>
              <span data-label="n" className="--i: 4">
                n
              </span>
              <span data-label="T" className="--i: 5">
                T
              </span>
              <span data-label="o" className="--i: 6">
                o
              </span>
              <span data-label="d" className="--i: 7">
                d
              </span>
              <span data-label="a" className="--i: 8">
                a
              </span>
              <span data-label="y" className="--i: 9">
                y
              </span>
            </span>
            ...
            {/* <span className="char state-2">
              ...
              <span data-label="N" className="--i: 5">
                N
              </span>
              <span data-label="o" className="--i: 6">
                o
              </span>
              <span data-label="w" className="--i: 7">
                w
              </span>
            </span> */}
          </div>
